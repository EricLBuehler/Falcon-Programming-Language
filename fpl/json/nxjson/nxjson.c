...
#define NX_JSON_CALLOC() (nx_json*)fpl_calloc(1, sizeof(nx_json))
#define NX_JSON_FREE(json) fpl_free((void*)(json))
...
#define NX_JSON_REPORT_ERROR(msg, p) vm_add_err(&ValueError, vm, "JSON parsing error at character '%c': '%s'", *p, msg)
